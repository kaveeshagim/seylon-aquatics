...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center mt-3 mb-3" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Seylon Aquatics</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('usertype') }}">User Types</a>
                <a class="collapse-item" href="{{ route('customers') }}">Customers</a>
                <a class="collapse-item" href="{{ route('subcustomers') }}">Sub Customers</a>
                <a class="collapse-item" href="{{ route('suppliers') }}">Suppliers</a>
            </div>
        </div>
    </li>
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
        <a class="nav-link" href="{{ route('passwordmanager') }}">
            <i class="fas fa-fw fa-table"></i>
