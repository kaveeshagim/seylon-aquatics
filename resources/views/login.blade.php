        ...
        <div class="relative bg-gray-50 dark:bg-gray-800 rounded-lg shadow ">
            ...
            <div class="p-4 md:p-5">
                <form id="passwordresetform" class="space-y-4">
                    <div>
                        <label for="username-reset" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your username<span class="text-red-500">*</span></label>
                        <input type="text" name="username-reset" id="username-reset"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                             required />
                    </div>
                    <div>
                        <label for="reason" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reason for password reset<span class="text-red-500">*</span></label>
      ...
      <div class="col-md-6">
        ...
        <div class="container">
          ...
          <div class="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg shadow-md">
            ...
            @csrf
              <div class="mb-4">
                <label for="username" autofill="false" autocomplete="off" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
              ...
              <div class="mb-4">
                ...
                <input type="password" name="password" autocomplete="off" id="password" class="bg-gray-50 border border-gray-600 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="true">
              ...
              <div class="mb-4 flex justify-between">
                ...
                <button id="passwordchangetoggle" data-modal-target="passwordreset-modal" data-modal-toggle="passwordreset-modal" 
