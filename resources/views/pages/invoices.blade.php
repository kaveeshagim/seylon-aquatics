    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Invoices</span>
        </div>
      </li>
    </ol>
  </nav>
...
<div class="px-4">
<h4 class="text-2xl font-bold dark:text-white">Invoices</h4>
<hr>
<div class="mb-4">
...
<table class="table table-bordered dataTable display" id=invoices-table" style="width:100%">
        <thead>
            <tr>
                <th>Datetime</th>
                <th>Cus Name</th>
