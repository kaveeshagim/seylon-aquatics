...
<nav class="flex" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Add Users</span>
        </div>
      </li>
    </ol>
  </nav>
    ...
    <h4 class="text-2xl font-bold dark:text-white">Add User</h4>
...
<!-- <script type="module">
    ...
    dismissBtn.addEventListener('click', function() {
        dismissAlert('alert-border-3', 'dismiss-button');
    });
