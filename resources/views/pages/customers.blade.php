...
<div class="px-4">
<h4 class="text-2xl font-bold dark:text-white">Customers</h4>
<hr>
<div class="mb-4">
<a href="{{ route('adduserpage') }}">
    <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add new customer</button>
</a>
...
<table class="table table-bordered dataTable display" id="customers-table" style="width:100%">
        <thead>
            <tr>
                <th>First Name</th>
                <th>Last Name</th>
      ...
      $('#customers-table').DataTable({
        ...
        "columns": [
          ...
          },
          {
            sortable: false,
            "render": function(data, type, full, meta) {
              return '<td><a style="color: #000000" href="" onclick=""><span class="fas fa-pencil-alt"></span></a></td>';
            }
          },
          {
            sortable: false,
