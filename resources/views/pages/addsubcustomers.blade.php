...
<div>
    ...
    <h4 class="text-2xl font-bold dark:text-white">Add Sub Customer</h4>
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2 font-medium">
        ...
        <div>
            <label for="maincustomer" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Main Customer</label>
            <select id="maincustomer" name="maincustomer" class="bg-gray-500 border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
