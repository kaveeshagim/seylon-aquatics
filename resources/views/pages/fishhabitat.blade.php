...
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased mt-12">
    ...
    <div id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-gray-50 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
