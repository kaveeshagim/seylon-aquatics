...
<div>
    ...
    <h4 class="text-2xl font-bold dark:text-white">Edit Fish Habitat</h4>
    ...
    @csrf
        ...
        <input hidden="true" type="text" id="fishhabitatid" name="fishhabitatid" class="bg-gray-500 border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value=<?php echo $data->id ?> required/>
