        ...
        <div class="relative bg-gray-50 rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" id="create-form">
                    ...
                    <div>
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Size (in letters) </label>
        ...
        "columns": [
          ...
          { "data": "userscount" },
          {
            ...
            "render": function(data, type, full, meta) {
                //   return '<td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><button onclick="editusertype(\'' + full.id + '\')" type="button" data-drawer-target="drawer-update-product" data-drawer-show="drawer-update-product" aria-controls="drawer-update-product" class="py-2 px-3 text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">'+
          ...
          },
          {
            sortable: false,
            "render": function(data, type, full, meta) {
            //   return '<td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><button onclick="deleteusertype(\'' + full.id + '\')" type="button" data-modal-target="delete-modal" data-modal-toggle="delete-modal" class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">'+
            //                       '<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 " viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">'+
