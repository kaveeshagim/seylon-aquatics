    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Suppliers</span>
        </div>
      </li>
    </ol>
  </nav>
...
<div class="px-4">
<h4 class="text-2xl font-bold dark:text-white">Suppliers</h4>
<hr>
<div class="mb-4">
<a href="{{ route('adduserpage') }}">
    <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add new supplier</button>
</a>
...
<table class="table table-bordered dataTable display" id="suppliers-table" style="width:100%">
        <thead>
            <tr>
                <th>First Name</th>
                <th>Last Name</th>
