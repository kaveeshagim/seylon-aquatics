      ...
      $('#users-table').DataTable({
        ...
        "columns": [
...

          {
            ...
            sortable: false,
            "render": function(data, type, full, meta) {
                return '<td><button type="button" onclick="editusers(\'' + full.id + '\')" class="text-xs py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">'+
