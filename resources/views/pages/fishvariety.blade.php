        ...
        <div class="bg-gray-50 dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="flex-1 flex items-center space-x-2">
                    <h5>
                        <span class="text-gray-500 dark:text-white">Fish Variety</span>
                    </h5>
                    
                </div>
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <button type="button" id="addnewvarietyButton" data-modal-toggle="create-modal" data-modal-target="create-modal" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
            ...
            <div class="overflow-x-auto">
                <table id="fishvariety-table" class="dataTable w-full text-sm text-left text-gray-500 dark:text-gray-400">
...
function searchdata() {
  $('#fishvariety-table').DataTable().destroy();
        ...
        "columns": [
          ...
          { "data": "scientific_name" },
              ...
              "render": function(data, type, full, meta) {
                  return '<span class="bg-red-100 text-red-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-red-900 dark:text-red-300">' + full.species + '</span>';
              }
          },
                    {
              sortable: false,
              "render": function(data, type, full, meta) {
                  return '<span class="bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-green-900 dark:text-green-300">' + full.family + '</span>';
              }
          },
          {
              sortable: false,
              "render": function(data, type, full, meta) {
                  return '<span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">' + full.habitat + '</span>';
              }
          },
